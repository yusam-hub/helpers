...
class ArrayHelper
{
    /**
     * @param $array
     * @param \Closure|string|array $key
     * @param mixed $default
     * @return mixed|null
     */
     ...
     */
    public static function isAssociative($array, bool $allStrings = true): bool
    {
     ...
     */
    public static function isIndexed($array, bool $consecutive = false)
    {
        if (!is_array($array)) {
            return false;
        }
